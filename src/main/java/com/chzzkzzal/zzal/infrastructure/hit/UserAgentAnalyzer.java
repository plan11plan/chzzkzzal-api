package com.chzzkzzal.zzal.infrastructure.hit;
...
public class UserAgentAnalyzer {
	...
	enum BrowserType {
		...
		public static BrowserType fromUserAgent(String userAgent) {
			...
			if (lowerCaseUserAgent.contains("chrome"))
				return CHROME;
			if (lowerCaseUserAgent.contains("firefox"))
				return FIREFOX;
			if (lowerCaseUserAgent.contains("safari"))
				return SAFARI;
